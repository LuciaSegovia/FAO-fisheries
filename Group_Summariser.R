...
Group_Summariser <- function(df1, group_ID_col, secondary_sort_col){
  ...
  group_ID_list <- sort(unique(as.numeric(group_IDs)))
  ...
  new_row[group_col_num] <- paste0("SUMMARY ROW - Group ", group_ID_value)
