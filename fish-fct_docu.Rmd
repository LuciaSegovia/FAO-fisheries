...
Similarly as it was performed with the fat, we combined three Tagnames into `VITB6_mg_standardised` as reported in the method section 3.4. 
...
Niacin was combined into the Niacin standardised variable (`NIAmg_std`) using the fucntion:`nia_conversion_creator` as reported in the method section 3.4.
