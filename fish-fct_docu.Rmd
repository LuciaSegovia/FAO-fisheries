...
data was not available." (REF). UF16 and WA19 reported "not preferred method" with brackets. 
...
###### 4.3. Data quality per each ICS FAOSTAT fish category
...
We checked the water content of dried products and of `fish_prep == "cured"`, to make sure that the water content of the fishery products were in line with their description. There were some fish items that seemed to have a rather high water content for dried products. 
