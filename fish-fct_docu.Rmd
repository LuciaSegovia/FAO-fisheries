...
with the water content of that item. However, because the item is driving the very high mean for
the category "Cephalopods, cured", 
`r mean(as.numeric(fao_fish_fct$CUmg[fao_fish_fct$ics_faostat_sua_english_description == "Cephalopods, cured"]))` we have decided to remove it from the calculations. 

`r mean(as.numeric(fao_fish_fct$CUmg[fao_fish_fct$ics_faostat_sua_english_description == "Cephalopods, cured" & fao_fish_fct$fdc_id != "10350"]))`

For future, and in order to minimise the influence of this type of items, more values
