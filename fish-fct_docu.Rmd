...
`subset(fao_fish_fct, fdc_id %in% c("04.043", "04.333", "04.107", "04.055"), select = c(food_desc, WATERg, SEmcg))`
...
We could impute some values in order to improve the ovearall mean of this SUA catergories, for instance:
