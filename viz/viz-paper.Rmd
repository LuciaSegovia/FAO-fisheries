...
fig4a <- fig3[[1]] / plot_spacer() / fig3[[2]]/ plot_spacer() / fig3[[3]] + plot_layout(heights = c(4,-1.5, 4, -1.5, 4 ))
...
fig4b <- fig3[[1]] / plot_spacer() / fig3[[2]]/ plot_spacer() / fig3[[3]] + plot_layout(heights = c(4,-1.5, 4, -1.5, 4 )) + 
  plot_annotation(title = "b",
                  theme = theme(plot.title = element_text(size = 23))) + plot_layout(guides = 'collect')
...
harmo_fct %>% 
  ggplot(aes(SOP_std)) + geom_histogram() +
 # geom_rect(aes(xmin = 95, ymin = -Inf, xmax = 95, ymax =Inf), 
  #          linetype = "dotted",alpha = 0, colour = "red", size = 2) +
  geom_rect(aes(xmin = 105, ymin = -Inf, xmax = 105, ymax =Inf), 
            linetype = "dotted",alpha = 0, colour = "red", size = 2) +
   theme_minimal() +
  theme(text = element_text(size = 23)) +
  labs(x="", y = "") 
