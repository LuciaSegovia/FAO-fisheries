...
JA15_Raw_FCT <- readxl::read_excel(here::here( 'JA15', "Japan_FCT.xlsx"), sheet = 1) %>%
...
JA15_Raw_FCT_Amino_Acids <- readxl::read_excel(here::here('JA15', "JA15_FCT_Amino_Acids.xlsx"), sheet = 1) %>%
  slice(-c(1:3))
...
JA15_Raw_FCT_CPOA <- readxl::read_excel(here::here('JA15', "JA15_FCT_Carbs_Polyols_Organic_Acids.xlsx"), sheet = 1) %>%
  slice(-c(1:3))
...
JA15_Raw_FCT_Fatty_Acids <- readxl::read_excel(here::here('JA15', "JA15_FCT_Fatty_Acids.xlsx"), sheet = 1) %>%
  slice(-c(1:3))
